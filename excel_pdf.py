...
for filepath in filepaths:
    ...
    # pdf.set_font(family='Times', size=12)
    # pdf.set_text_color(80, 80, 80)
    # pdf.cell(w = 25, h = 8, txt="", border = 1, align = 'L', fill = False)
    # pdf.cell(w = 70, h = 8, txt="", border = 1, align = 'L', fill = False)
    # pdf.cell(w = 40, h = 8, txt="", border = 1, align = 'L', fill = False)
    # pdf.cell(w = 30, h = 8, txt="", border = 1, align = 'L', fill = False)
